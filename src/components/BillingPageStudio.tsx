...
export default function BillingPageStudio() {
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  variant={plan.current ? 'outline' : plan.popular ? 'premium' : 'outline'}
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {creditPacks.map((pack, index) => (
            <Card 
              key={pack.name} 
              className={`glass-card transition-all duration-normal hover:shadow-design-lg ${
