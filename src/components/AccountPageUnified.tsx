...
interface AccountPageUnifiedProps {
  onNavigateToBilling: () => void;
}

export const AccountPageUnified: React.FC<AccountPageUnifiedProps> = ({ onNavigateToBilling }) => {
    ...
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button 
          ...
          className="gap-2 bg-gradient-primary text-text-primary font-semibold shadow-design-md hover:shadow-design-glow hover:scale-[1.02] active:scale-[0.98]"
        >
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="grid w-full grid-cols-4 mb-8 bg-bg-secondary">
          <TabsTrigger value="profile" className="gap-2 data-[state=active]:bg-hover-overlay">
            <User className="w-4 h-4" />
            Profile
          </TabsTrigger>
          <TabsTrigger value="security" className="gap-2 data-[state=active]:bg-hover-overlay">
            <Shield className="w-4 h-4" />
            Security
          </TabsTrigger>
          <TabsTrigger value="preferences" className="gap-2 data-[state=active]:bg-hover-overlay">
            <Settings className="w-4 h-4" />
            Preferences
          </TabsTrigger>
          <TabsTrigger value="subscription" className="gap-2 data-[state=active]:bg-hover-overlay">
            <Crown className="w-4 h-4" />
            Subscription
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-6">
                <div className="relative">
                  ...
                  <Button size="sm" variant="ghost" className="absolute -bottom-2 -right-2 rounded-full bg-bg-secondary border border-border-primary w-8 h-8 p-0">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="firstName" defaultValue="John" className="bg-bg-secondary border-border-primary" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">Last Name</Label>
                  <Input id="lastName" defaultValue="Doe" className="bg-bg-secondary border-border-primary" />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" type="email" defaultValue="john@creategen.studio" className="bg-bg-secondary border-border-primary" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="username">Username</Label>
                <Input id="username" defaultValue="@johndoe" className="bg-bg-secondary border-border-primary" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="bio">Bio</Label>
                <Input id="bio" placeholder="Tell us about yourself..." className="bg-bg-secondary border-border-primary" />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="currentPassword" type="password" className="bg-bg-secondary border-border-primary" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="newPassword">New Password</Label>
                    <Input id="newPassword" type="password" className="bg-bg-secondary border-border-primary" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword">Confirm New Password</Label>
                    <Input id="confirmPassword" type="password" className="bg-bg-secondary border-border-primary" />
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="language" defaultValue="English (US)" className="bg-bg-secondary border-border-primary" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="timezone">Timezone</Label>
                    <Input id="timezone" defaultValue="UTC-5 (Eastern Time)" className="bg-bg-secondary border-border-primary" />
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="glass-card">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button 
                  onClick={onNavigateToBilling}
                  className="gap-2 bg-gradient-primary text-text-primary font-semibold"
                >
                  <Crown className="w-4 h-4" />
                  Upgrade Plan
                </Button>
