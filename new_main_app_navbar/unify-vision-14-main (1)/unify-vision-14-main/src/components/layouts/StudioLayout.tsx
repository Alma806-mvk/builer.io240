          ...
          <header className="sticky top-0 z-50 border-b border-border-secondary bg-bg-primary/80 backdrop-blur-xl">
            <div className="flex h-16 items-center justify-between px-6">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Settings */}
                <Button variant="ghost" size="icon" className="hover-glow" onClick={() => navigate('/settings')}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 glass-card border-border-primary">
                    ...
                    <DropdownMenuItem className="gap-2 text-text-secondary hover:text-text-primary" onClick={() => navigate('/profile')}>
                      <User className="w-4 h-4" />
                      Profile
                    </DropdownMenuItem>
                    <DropdownMenuItem className="gap-2 text-text-secondary hover:text-text-primary" onClick={() => navigate('/billing')}>
                      <Settings className="w-4 h-4" />
